...
namespace App\Http\Controllers\Api\Webapp\Book;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\Book\Matra AS RecordModel;
...
class MatraController extends Controller
{
    ...
    public function index(Request $request){
         ...
         */
        $activeBookIds = \App\Models\Book\Book::where('active',1)->where('complete',1)->pluck('id')->toArray();
    ...
    {
        if (($user = $request->user()) !== null) {
            $crud = new CrudController(new RecordModel(), $request, ['id', 'aid', 'title', 'meaning', 'book_id', 'archive', 'kunty_id', 'kunty', 'matika_id', 'matika', 'chapter_id', 'chapter', 'part_id', 'part', 'section_id', 'section', 'created_by', 'author', 'updated_by', 'editor']);
